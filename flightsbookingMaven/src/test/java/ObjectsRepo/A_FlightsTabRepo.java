...
public class A_FlightsTabRepo {
	...
	public static final By DepartingDate = By.xpath("//div[@id='flight-departing-wrapper-hp-flight']//span[@class='label']");
	...
	public static final By TravellersTab = By.xpath(
			"//form[@id='gcw-flights-form-hp-flight']//div[@class='ab25184-traveler-wrapper-flight available-for-flights gcw-clear-both']//ul[@class='menu-bar-inner']/li/button[@type='button']");
	...
	public static final By FromCallender = By.xpath("//div[@class='datepicker-cal']");
